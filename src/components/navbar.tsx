...
const Navbar = async () => {
  ...
  return (
    <div className="supports-backdrop-blur:bg-black/60 sticky left-0 right-0 top-0 z-20 border-b bg-slate-900/65 backdrop-blur">
      <nav className="container flex h-16 items-center px-4">
        <div className="mr-4 flex">
          <div className="flex">
            <Link className="text-lg font-semibold text-nowrap" href="/">
              <span className="text-red-600">Stream</span>ID
            </Link>
          </div>
        </div>
